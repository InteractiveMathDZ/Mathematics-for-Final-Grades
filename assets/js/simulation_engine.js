...
function buildTrigonometricCircle(id, config) {
    ...
    const theme = {
        axisColor: isDark ? '#ffffff' : '#555555',       // محاور بيضاء ناصعة في العتمة / سوداء حادة في الضياء
        gridColor: isDark ? '#444444' : '#e5e5e5',       // شبكة خافتة جداً لمنع التداخل البصري مع أسطر الجداول
