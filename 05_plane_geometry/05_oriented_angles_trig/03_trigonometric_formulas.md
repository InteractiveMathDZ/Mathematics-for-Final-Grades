...
elements:
  - h3: "1. دساتير المجموع والفرق (الآلية الحاكمة للتفكيك)"
    id: "sum-difference-formulas"

  - parags:
      - rtl: "من أجل أي عددين حقيقيين $a$ و $b$، تخضع دالات الجيب والجيب تمام لقوانين التحويل الصارمة التالية والتي تسمح بنشر المجموع والفرق كلياً:"
  ...
  - tableLines:
      ...
      lines:
        - - th: "العملية المستهدفة"
          ...
          - th: "القاعدة الذهبية للحفظ والصيانة"
        - - th: "جيب تمام المجموع"
          - td: "$\\cos(a + b) = \\cos a \\cos b - \\sin a \\sin b$"
          - td: "الـ $\\cos$ أناني ومتناقض: يجمع الدالات معاً ويعكس إشارة الوسط حتماً."
        - - th: "جيب تمام الفرق"
          - td: "$\\cos(a - b) = \\cos a \\cos b + \\sin a \\sin b$"
          - td: "الـ $\\cos$ يضرب الـ $\\cos$ والـ $\\sin$ يضرب الـ $\\sin$ مع قلب الناقص زائداً."
        - - th: "جيب المجموع"
          - td: "$\\sin(a + b) = \\sin a \\cos b + \\cos a \\sin b$"
          - td: "الـ $\\sin$ اجتماعي ومحافظ: يخلط الدالات ويحافظ على إشارة الوسط تماماً."
        - - th: "جيب الفرق"
          - td: "$\\sin(a - b) = \\sin a \\cos b - \\cos a \\sin b$"
          - td: "يخلط جيب الأولى في جيب تمام الثانية ناقص جيب تمام الأولى في جيب الثانية."

  - h3: "2. دساتير المضاعفة (صيغ ضعف الزاوية $2a$)"
    id: "double-angle-formulas"

  - parags:
      - rtl: "بوضع $b = a$ في دساتير المجموع السابقة، ننتج ميكانيكياً قوانين التضعيف الحاكمة التي تختزل الزوايا المضاعفة:"
      - center: "$$\\sin(2a) = 2 \\sin a \\cos a$$"
      - center: "$$\\cos(2a) = \\cos^2 a - \\sin^2 a$$"
      - rtl: "<strong>صيغ التمديد الناتجة:</strong> باستغلال العلاقة الأم ($\\cos^2 a + \\sin^2 a = 1$)، يمكن إعادة صياغة $\\cos(2a)$ بشكلين آخرين لتسهيل عزل المربعات الحسابية:"
