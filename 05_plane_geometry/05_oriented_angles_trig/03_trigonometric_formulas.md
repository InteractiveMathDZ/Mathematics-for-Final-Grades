...
elements:
  ...
  - parags:
      - rtl: "من أجل أي عددين حقيقيين $a$ و $b$، تخضع دوال الجيب والجيب تمام لقوانين التحويل التالية والتي تسمح بنشر المجموع والفرق:"
  ...
  - tableLines:
      ...
      lines:
        - - th: "الزاوية الناتجة"
          ...
          - th: "إسقاط الجيب ($\\sin$)"
        - - th: "الزاوية المعاكسة <br> ($-a$)"
          - td: "$\\cos(-a) = \\cos a$ <br> (دالة زوجية تصمد)"
          - td: "$\\sin(-a) = -\\sin a$ <br> (دالة فردية تطرد السالب)"
        - - th: "الزاوية المكملة <br> ($\\pi - a$)"
          - td: "$\\cos(\\pi - a) = -\\cos a$"
          - td: "$\\sin(\\pi - a) = \\sin a$"
        - - th: "الزاوية بزيادة نصف دورة <br> ($\\pi + a$)"
          - td: "$\\cos(\\pi + a) = -\\cos a$"
          - td: "$\\sin(\\pi + a) = -\\sin a$"

  - h3: "4. مثال تطبيقي (حساب قيمة زاوية غير مألوفة)"
    id: "trig-formulas-ex"

  - parags:
      - rtl: "احسب قيمة:"
      - center: "$\\cos\\left(\\frac{\\pi}{12}\\right)$"
      - rtl: " باستغلال دساتير التحويل، علماً أن:"
      - center: "$\\frac{\\pi}{12} = \\frac{\\pi}{3} - \\frac{\\pi}{4}$."
  ...
  - tableLines:
      ...
      lines:
        ...
        - - th: "2. التعويض بالقيم الشهيرة"
          - td: "نعوض القيم المعروفة <br>$\\cos\\frac{\\pi}{3}=\\frac{1}{2}$ ، $\\cos\\frac{\\pi}{4}=\\frac{\\sqrt{2}}{2}$ ، $\\sin\\frac{\\pi}{3}=\\frac{\\sqrt{3}}{2}$ ، $\\sin\\frac{\\pi}{4}=\\frac{\\sqrt{2}}{2}$"
  ...
  - NB:
      ...
      title: "قاعدة:"
      NBs:
        - rtl: "دساتير التحويل هي مفاتيح تفكيك التعقيد في العبارات المثلثية؛ تذكر دائماً أن جيب التمام يعكس الإشارات ويجمع الدوال المتشابهة، بينما الجيب يحافظ على الإشارة ويخلط الدوال بالتناوب."

  - h3: "5. تطبيقات شحذ المهارة"
    id: "app-trigonometric-formulas"

  - exemple:
      title: "1.5. توظيف دساتير الضعف لإنشاء معادلات مثلثية من الدرجة الثانية وحلها وعزل جذورها"
      exemID: "ex-trigf-001"
  - exemple:
