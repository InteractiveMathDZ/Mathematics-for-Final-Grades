...
elements:
  ...
  - parags:
      ...
      - rtl: "نرمز لمجموعة القيم الممكنة التي يأخذها المتغير العشوائي $X$ بالرمز $X(\\Omega)$، وهي مجموعة منتهية من الأعداد الحقيقية نكتبها مرتبة تصاعدياً كالتالي:"
      - center: "$X(\\Omega) = \\{x_1, x_2, \\dots, x_n\\}$."
  ...
  - parags:
      ...
      - rtl: "نرمز لهذا الاحتمال بالرمز $p_i$ حيث:"
      - center: "$p_i = P(X = x_i)$."
      - rtl: "• <b>الشرط النظامي:</b> لكي يكون قانون الاحتمال صحيحاً ومستوياً هندسياً، يجب أن يتحقق شرطان جبريان:"
      - rtl: "1. كل احتمال مصاحب هو عدد محصور بين الصفر والواحد:"
      - center: "$0 \\le p_i \\le 1$ لكل $i$."
  ...
  - parags:
      - rtl: "يتم تلخيص قانون الاحتمال في جدول نظامي يربط كل قيمة بالاحتمال الصافي المطابق لها:"
