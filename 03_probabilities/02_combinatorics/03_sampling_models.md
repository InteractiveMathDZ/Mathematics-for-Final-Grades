...
elements:
  ...
  - graph:
      ...
      elements:
        - {
            type: "text",
            content: "سحب في آن واحد: الترتيب غير مهم (C)",
            x: 2,
            y: 2.5,
          }
        - {
            type: "text",
            content: "سحب على التوالي بإرجاع: الترتيب مهم مع التكرار (n^p)",
            x: 2,
            y: 1.5,
          }
        - {
            type: "text",
            content: "سحب على التوالي بدون إرجاع: الترتيب مهم بدون تكرار (A)",
            x: 2,
            y: 0.5,
          }
