...
elements:
  ...
  - parags:
      - rtl: "قبل بناء الدستور الكلي، يجب ضبط الأرضية النظرية: نقول عن مجموعة من الحوادث $B_1, B_2, \\dots, B_n$ أنها تشكل <b>تجزئة تامة</b> للفضاء العيني $\\Omega$ إذا حققت الشرطين التلليين:"
