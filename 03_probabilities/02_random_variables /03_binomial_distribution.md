...
elements:
  ...
  - parags:
      - rtl: "نعرف المتغير العشوائي البرنولي $X$ الذي يرفق النتيجة $S$ بالعدد $1$ والنتيجة $\\bar{S}$ بالعدد $0$. مجموعة القيم الممكنة هي $X(\\Omega) = \\{0, 1\\}$، وقانون احتماله يُعطى كما يلي:"
      - rtl: "• $P(X = 1) = p$"
      - rtl: "• $P(X = 0) = 1 - p = q$"
