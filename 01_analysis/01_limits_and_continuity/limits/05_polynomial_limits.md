...
elements:
  ...
  - NB:
      - rtl: "<strong>تنبيه حاسم:</strong><br>
      هذه القاعدة (أكبر حد) تُطبق <strong>فقط
 </strong> عند $+\\infty$ أو $-\\infty$. لا يجوز بتاتاً استخدامها عند حساب النهاية عند عدد حقيقي $a$."
