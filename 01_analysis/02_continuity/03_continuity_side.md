...
elements:
  ...
  - parags:
      - rtl: "الدالة <b> الدستورية أو المنشطرة</> كترجمة مباشرة ل split-function، هي دالة بأكثر من عبارة جبرية على مجالات مختلفة."
      - rtl: "لتكن الدالة الدستورية $f$ المعرفة بـ:"
