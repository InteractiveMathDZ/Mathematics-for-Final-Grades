...
elements:
  ...
  - parags:
      - rtl: "التزايد المقارن يخبرنا أن $e^x$ أسرع بكثير في الوصول إلى $+\infty$ من $x$ أو $x^2$ أو $x^n$. لذلك، في أي 'صراع' (ضرب أو قسمة) عند الما لا نهاية، النتيجة تُحسم لصالح الأسية."
  ...
  - NB:
      title: "قاعدة الأرتيزان (المقامات القوية):"
      type: "success"
      NBs:
