...
elements:
  ...
  - h3: "4. المستقيم المقارب المائل:"
    id: "oblique-asymp"

  - parags:
      - rtl: "يكون المنحنى $(\\mathcal{C}_f)$ يقبل مستقيماً مقارباً مائلاً إذا كانت الدالة تكتب من الشكل $f(x) = (ax+b) + g(x)$ حيث نهاية $g(x)$ عند اللانهاية هي الصفر."
