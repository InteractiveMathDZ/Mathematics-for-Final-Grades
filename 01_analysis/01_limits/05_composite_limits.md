...
elements:
  ...
  - NB:
      type: "primary"
      title: "✨ خارج المقرر: لغز التذبذب اللانهائي بجوار الصفر"
      NBs:
        - rtl: "إذا قمت بتكبير الرسم البياني السابق واقتربت جداً من مركز المحاور عند النقطة $(0,0)$، ستلاحظ سلوكاً عجيباً: المنحنى يتأرجح ويهتز بعنف وبسرعة فائقة يميناً ويساراً! هذا السلوك يسمى علمياً <b>الاهتزاز المخمد (Damped Oscillation)</b>، وهو غير مقرر عليك في الامتحانات، لكن فهمه يمنحك ملكة تحليلية راقية:"
        - rtl: "1. <b>التردد اللانهائي:</b> كلما اقترب المتغير $x$ من الصفر، فإن مقلوبه $\\frac{1}{x}$ يؤول إلى ما لا نهاية ($\\pm\\infty$). هذا الارتفاع الفجائي والضخم في القيمة يجعل دالة الجيب ($\\sin$) تضطر لعمل دورات موجية كاملة في مسافات ميكروسكوبية ضيقة جداً، فتتكرر الأمواج بسرعة تقترب من اللانهاية كلما اقتربنا من المركز!"
        - rtl: "2. <b>كمين الحصر والتخميد:</b> رغم هذا الهيجان والسرعة اللانهائية للأمواج بجوار الصفر، إلا أن وجود المتغير $x$ المضروب في الخارج يعمل كـ 'فرامل' تخنق سعة هذه الموجة. وبما أن قيم الـ $\\sin$ محبوسة دائماً بين $-1$ و $1$، فإن المنحنى بأكمله ينضغط ويُسحق بالتدريج كلما اقترب من المركز ليستقر ويموت تماماً عند الصفر الحقيقي: $\\lim\\limits_{x \\to 0} x \\sin\\left(\\frac{1}{x}\\right) = 0$."
