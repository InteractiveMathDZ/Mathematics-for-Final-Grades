...
elements:
  ...
  - tableSlides:
      slides:
        - title: "الفجوات والنقاط"
          interpretation: "تقارب نقط المنحنى نحو نقطة معلومة أو فجوة: تؤول الصور نحو قيمة منتهية $L$."
          formula: "$$\\lim\\limits_{x \\to a} f(x) = L$$"
        - title: "الامتداد اللانهائي صعوداً بجوار جدار"
          interpretation: "اندفاع المنحنى بشكل غير محدود نحو الأعلى بجوار مستقيم عمودي."
          formula: "$$\\lim\\limits_{x \\to a} f(x) = +\\infty$$"
        - title: "الامتداد اللانهائي نزولاً بجوار جدار"
          interpretation: "انحدار المنحنى بشكل غير محدود نحو الأسفل بجوار مستقيم عمودي."
          formula: "$$\\lim\\limits_{x \\to a} f(x) = -\\infty$$"
        - title: "الاستقرار الأفقي عند الأطراف"
        ...
        - title: "الاندفاع نحو الأعلى عند الأطراف"
          interpretation: "اندفاع المنحنى بشكل غير محدود نحو الأعلى عند الأطراف اللانهائية."
