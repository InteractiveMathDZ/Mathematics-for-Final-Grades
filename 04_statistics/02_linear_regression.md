...
previous_title: "المبحث 1: السحابة النقطية والنقطة المتوسطة"
previous_url: "/point_cloud/"
next_title: "المبحث 3: التعديل غير الخطي والتنبؤ الاستشرافي"
...
elements:
  ...
  - parags:
      ...
      - rtl: "هذه العملية تسمى <b>التعديل الخطي</b>، والمستقيم الناتجة يُسمى <b>مستقيم التراجع (Regression Line)</b> لـ $Y$ بدلالة $X$ ومعادلته الجبرية من الشكل: $y = ax + b$."

  - h3: "2. مبدأ المربعات الدنيا (Least Squares Criterion)"
  - parags:
      - rtl: "لتحديد المستقيم الأمثل بدقة مطلقة، نعتمد على طريقة المربعات الدنيا. المبدأ الرياضي يقوم على <b>تدنية (Minimization)</b> مجموع مربعات المسافات الشاقولية بين النقط الحقيقية للسحابة والنقط المقابلة لها على المستقيم النظري."
  ...
  - NB:
      title: "قاعدة ذهبية للتحقق الهندي:"
      type: "info"
      NBs:
